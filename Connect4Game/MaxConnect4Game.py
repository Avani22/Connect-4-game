...
class Minmax:
    ...
    def makeDecision(self):
        minValues=[]
        possMoves=movesPossible(self.game.gameBoard)
    ...
    def minVal(self,state,alpha,beta):
        ...
        v=99999             #maximum alpha value

        for move in movesPossible(state.gameBoard):
...
class maxConnect4Game:
    ...
    def aiPlay(self,currentGame,depth):
        searchTree=Minmax(currentGame, depth)
